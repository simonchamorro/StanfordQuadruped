...
class JoystickInterface:
    def __init__(
        ...
        self.previous_step_gripper_toggle = 0
    ...
    def get_command(self, state, do_print=False):
        try:
            ...
            if state.arm_state is ArmState.DEACTIVATED:
                ...
                grab_toggle = 0
                step_gripper_toggle = 0
            else:
                gait_toggle = 0
                activate_toggle = 0
                hop_toggle = 0
                grab_toggle = msg["x"]
                step_gripper_toggle = msg["circle"]
                command.gripper_event = grab_toggle == 1 and self.previous_grab_toggle == 0
                command.step_gripper_event = step_gripper_toggle == 1 and self.previous_step_gripper_toggle == 0
            ...
            self.previous_step_gripper_toggle = step_gripper_toggle
