    ...
    while True:
        ...
        while True:
            ...
            if currently_recording:
                states[str(time.time())] = {
                    "feet": np.copy(state.foot_locations),
                    "joints": np.copy(state.joint_angles),
                    "height": np.copy(state.height),
                    "yaw": np.copy(state.yaw_rate),
                    "pitch": np.copy(state.pitch),
